...
public class TreeDumpWebscript extends DeclarativeWebScript {
    private Log log = LogFactory.getLog(TreeDumpWebscript.class);

    private TreeDumpEngine treeDumpEngine;
    private ExecutorService executorService;
    private Future<?> treeDumpTask;

    public TreeDumpWebscript(TreeDumpEngine treeDumpEngine) {
